...
gnuplot << EOF
    ...
    plot haar(x, 1, 0) t "a=1, b=0" linewidth 5 linetype rgb "black", \
        haar(x, 0.25, 3) t "a=0.25, b=3" linewidth 5 linetype rgb "red", \
        haar(x, 4, 5) t "a=4, b=5" linewidth 5 linetype rgb "blue"
    ...
    plot haar_scaling_discrete(x, 0, 0) t "m=0, n=0" linewidth 5 linetype rgb "black", \
        haar_scaling_discrete(x, 2, 8) t "m=2, n=8" linewidth 5 linetype rgb "red", \
        haar_scaling_discrete(x, -2, 1) t "m=-2, n=1" linewidth 5 linetype rgb "blue"
