...
\author[aikiriao]{Available at: \qrcode[hyperlink,height=20mm]{https://speakerdeck.com/aikiriao/ueburetutookimotijiang-zuo}\\ Source: {\scriptsize \myurl{https://github.com/aikiriao/introduction_to_wavelet}}}
\date{\today}
...
\begin{frame}[c]
    ...
    \end{align}
    積分範囲$[a,b]$は対象により変わる．積分変数を省略して$\innprod{f}{g}$とも書く．考え方は，有限次元ベクトルと同じ：
    \begin{align*}
...
\begin{frame}[c]
    \frametitle{展開係数の入力による近似}
    \scriptsize
    （証明）$\phi$は仮定より，ある範囲$[-L,L]$の外では常に$0$として考える．このとき$p_{M}[n]$は，
    \begin{align*}
